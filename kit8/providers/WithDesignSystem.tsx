...
export interface WithDesignSystemType {
...
export type DesignSystemContextType = WithDesignSystemType;

const DesignSystemContext = createContext<WithDesignSystemType>({
  activeSystem: 'paper',
  setActiveSystem: () => {},
...
export const WithDesignSystem: React.FC<{ children: React.ReactNode }> = ({ children }) => {
...
export const DesignSystemProvider = WithDesignSystem;

export const useDesignSystem = (): WithDesignSystemType => {
  const context = useContext(DesignSystemContext);
  if (!context) {
    throw new Error('useDesignSystem must be used within a WithDesignSystem provider');
  }
  return context;
};
