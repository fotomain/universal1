...
const WithSQLiteNative = (props: any) => {
    ...
    useEffect(() => {
        ...
        async function fetchUserId() {
            ...
            try {
                ...
                console.error("Error loading user data for WithSQLiteNative:", err)
            }
        }
        fetchUserId()
...
export const SQLiteNativeProvider = WithSQLiteNative;
...
export const useSQLiteNative = useSQLNative;

export default WithSQLiteNative
